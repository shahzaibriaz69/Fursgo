...
<body>
    <div class="fs-container">
        ...
        <div class="fs-card card-2">
            ...
            <div class="card-body">
                <p class="status-msg">You are speaking with FursGo.</p>

                <div class="chat-bubble user-msg">I need support with bookings.</div>

                <div class="chat-bubble bot-msg">Got it 👍 What's the issue with your booking?</div>

                <div class="option-buttons">
                    <button class="opt-btn">Change or cancel a booking <span>&gt;</span></button>
                    <button class="opt-btn">Booking is pending <span>&gt;</span></button>
                    <button class="opt-btn">Something else <span>&gt;</span></button>
                </div>

                <div class="input-area">
                    <input type="text" placeholder="Write a message...">
                    <div class="input-footer">
                        <span>📎 Attach &nbsp; 🖼️ Upload</span>
                        <span>0/3,000</span>
                    </div>
                </div>
            </div>
