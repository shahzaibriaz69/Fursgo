    ...
    <div class="main-conatiner">
        ...
        <section id="spaces-sec" class="tab-content favourite-spaces" style="display:none;">
            <section class="favourite-spaces">
                ...
                <div class="top-bar">
                    <div class="tabs">
                        <button class="tab-link" onclick="showSection(event, 'groomers-sec')">Groomers</button>
                        <button class="tab-link active" onclick="showSection(event, 'spaces-sec')">Space</button>
                    </div>
                ...
                <div class="feature-section">
                    ...
                    <div class="filter-section">
                        <button class="filter">Venue <svg xmlns="http://www.w3.org/2000/svg" width="13" height="7"
                                viewBox="0 0 13 7" fill="none">
                                <path d="M11.9102 0.5L6.15672 6.25344L0.499867 0.596581" stroke="#FBAC83"
                                    stroke-linecap="round" stroke-linejoin="round" />
                            </svg></button>
                    ...
                    <div class="social-icons">
                        ...
                        <div class="soical-group-icon">
                            ...
                            <span class="icon-tg"><svg xmlns="http://www.w3.org/2000/svg" width="48" height="48"
                                    ...
                                    <defs>
                                        <linearGradient id="paint0_linear_50_1863" x1="2400" y1="0" x2="2400" y2="4800"
